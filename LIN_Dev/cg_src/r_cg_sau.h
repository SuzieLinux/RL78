...
#define _00_SAU_TI03_INPUT                      (0x00U) /* uses input signal of the TI03 pin as a timer input */
...
#define _00_SAU_INTP0_INTERRUPT                 (0x00U) /* uses input signal of the INTP0 as an external interrupt */
#define _01_SAU_RxD0_INTERRUPT                  (0x01U) /* uses input signal of the RxD0 as an external interrupt */
...
Macro definitions
***********************************************************************************************************************/
#define _9A00_SAU_CH0_BAUDRATE_DIVISOR          (0x9A00U) /* transfer clock set by dividing the operating clock */
#define _9A00_SAU_CH1_BAUDRATE_DIVISOR          (0x9A00U) /* transfer clock set by dividing the operating clock */
#define _9A00_SAU_CH3_BAUDRATE_DIVISOR          (0x9A00U) /* transfer clock set by dividing the operating clock */

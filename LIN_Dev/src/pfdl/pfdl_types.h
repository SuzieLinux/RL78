...
typedef enum
{
    ...
    PFDL_ERR_NO_H_ID          = (0x06),    /* 0x06, Hardware ID not programmed               */
    PFDL_ERR_NO_E_CONFIG      = (0x07),     /* 0x07, Extra configuration not programmed       */
    PFDL_ERR_ERASED           = (0x08)     /* 0x08, Extra configuration is ERASED            */
} pfdl_status_t;                           /* ---------------------------------------------- */
...
enum
{
    R_PFDLT04_ASSERT_CHECK = R_PFDLT04_STATIC_ASSERT_SIZE(pfdl_u08, 1)           /* Check unsigned type */

...
#define LCIF0 IF2L_bit.no0
#define MDIF IF2L_bit.no3
#define FLIF IF2L_bit.no4
#define LCMK0 MK2L_bit.no0
#define MDMK MK2L_bit.no3
#define FLMK MK2L_bit.no4
#define LCPR00 PR02L_bit.no0
#define MDPR0 PR02L_bit.no3
#define FLPR0 PR02L_bit.no4
#define LCPR10 PR12L_bit.no0
#define MDPR1 PR12L_bit.no3
#define FLPR1 PR12L_bit.no4
...
#define TMIF03H IF1L_bit.no0
#define IICAIF0 IF1L_bit.no1
#define TMIF01 IF1L_bit.no2
#define TMIF02 IF1L_bit.no3
#define TMIF03 IF1L_bit.no4
#define ADIF IF1L_bit.no5
#define RTCIF IF1L_bit.no6
#define ITIF IF1L_bit.no7
...
#define TMMK03H MK1L_bit.no0
#define IICAMK0 MK1L_bit.no1
#define TMMK01 MK1L_bit.no2
#define TMMK02 MK1L_bit.no3
#define TMMK03 MK1L_bit.no4
#define ADMK MK1L_bit.no5
#define RTCMK MK1L_bit.no6
#define ITMK MK1L_bit.no7
...
#define TMPR003H PR01L_bit.no0
#define IICAPR00 PR01L_bit.no1
#define TMPR001 PR01L_bit.no2
#define TMPR002 PR01L_bit.no3
#define TMPR003 PR01L_bit.no4
#define ADPR0 PR01L_bit.no5
#define RTCPR0 PR01L_bit.no6
#define ITPR0 PR01L_bit.no7
...
#define TMPR103H PR11L_bit.no0
#define IICAPR10 PR11L_bit.no1
#define TMPR101 PR11L_bit.no2
#define TMPR102 PR11L_bit.no3
#define TMPR103 PR11L_bit.no4
#define ADPR1 PR11L_bit.no5
#define RTCPR1 PR11L_bit.no6
#define ITPR1 PR11L_bit.no7
